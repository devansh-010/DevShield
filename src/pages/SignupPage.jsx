...
import { Shield, Mail, Lock, User, Github, Linkedin, LifeBuoy } from 'lucide-react';
            ...
            >
                <div className="glass rounded-2xl p-8 border border-white/10 shadow-2xl shadow-black/50">
                    ...
                    <div className="text-center mb-8">
                        <Link to="/" className="inline-flex items-center justify-center gap-2 font-bold text-xl tracking-tight text-white mb-6">
                            <Shield className="w-6 h-6 text-primary fill-primary/20" />
                            <span>Dev<span className="text-primary">Shield</span></span>
                        </Link>
                        <h2 className="text-2xl font-bold text-white mb-2">Create an Account</h2>
                        <p className="text-slate-400 text-sm">Start securing your code today</p>
                    </div>
                    ...
                    <form className="space-y-4">
                        ...
                        <Button variant="primary" className="w-full h-12 bg-gradient-to-r from-primary to-blue-600 hover:to-blue-500 border-none shadow-lg shadow-primary/20 mt-2">
                            Sign Up
                        </Button>
                    </form>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5 space-y-6">
                        <div className="text-center">
                            <p className="text-sm text-slate-400">
                                Already have an account? <Link to="/login" className="text-primary hover:text-primary/80 font-medium">Log In</Link>
                            </p>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-[#0b1022] px-2 text-slate-500">Sign up with</span>
                            </div>
                        </div>
